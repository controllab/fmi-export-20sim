...
#define N_VMAKE(v, v_data, v_len) v = (iN_Vector*) malloc(sizeof(*v)); \
                                  v->data   = v_data; \
                                  v->length = v_len
 ...
 *-------------------------------------------------------------*
 *                                                             *
 * Frees the iN_Vector* x. It is illegal to use x after the call *
 * N_VFree(x).                                                 *
 *                                                             *
 ***************************************************************/
...
/***************************************************************
 *                                                             *
 * iN_Vector* Arithmetic: N_VLinearSum, N_VConst, N_VProd,       *
 ...
 * called only with an iN_Vector* x which is guaranteed to have  *
...
/***************************************************************
 *                                                             *
 * iN_Vector* Measures: N_VDotProd, N_VMaxNorm, VWrmsNorm,       *
 *                    N_VMin                                   *
 *                                                             *
 ***************************************************************/
 ...
 *-------------------------------------------------------------*
 *                                                             *
 * Prints the iN_Vector* x to stdout. Each component of x is     *
