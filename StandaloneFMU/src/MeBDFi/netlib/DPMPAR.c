/* DPMPAR.F -- translated by f2c (version 20010821).
...
/*    ret_val = dmach[(0 + (0 + (*i__ - 1 << 3))) / 8]; */
	...
	/* grn: explicit operator precedence to clarify behavior */
	/* the argument is one base, and must be made zero based */
	/* this result should is multiplied by 8 and divided by 8 */
    ret_val = dmach[(0 + (0 + ( (*i__ - 1) << 3))) / 8];
/*<       return >*/
    return ret_val;
