...
%ENDIF%
%IF%%NUMBER_STATES%
#define %VARPREFIX%%XX_STATE_ARRAY_NAME% %VARPREFIX%model_instance->%XX_STATE_ARRAY_NAME%
#define %VARPREFIX%%XX_RATE_ARRAY_NAME% %VARPREFIX%model_instance->%XX_RATE_ARRAY_NAME%
%ENDIF%
%IF%%NUMBER_MATRICES%
#define %VARPREFIX%%XX_MATRIX_ARRAY_NAME% %VARPREFIX%model_instance->%XX_MATRIX_ARRAY_NAME%
%ENDIF%
%IF%%NUMBER_UNNAMED%
#define %VARPREFIX%%XX_UNNAMED_ARRAY_NAME% %VARPREFIX%model_instance->%XX_UNNAMED_ARRAY_NAME%
%ENDIF%
%IF%%WORK_ARRAY_SIZE%
#define %VARPREFIX%workarray %VARPREFIX%model_instance->workarray
%ENDIF%
%IF%%NUMBER_IMPORTS%
#define %VARPREFIX%%XX_EXT_IN_ARRAY_NAME% %VARPREFIX%model_instance->%XX_EXT_IN_ARRAY_NAME%
%ENDIF%
%IF%%NUMBER_EXPORTS%
#define %VARPREFIX%%XX_EXT_OUT_ARRAY_NAME% %VARPREFIX%model_instance->%XX_EXT_OUT_ARRAY_NAME%
%ENDIF%
%IF%%NUMBER_FAVORITE_PARAMETERS%
#define %VARPREFIX%%XX_FAVORITE_PARS_ARRAY_NAME% %VARPREFIX%model_instance->%XX_FAVORITE_PARS_ARRAY_NAME%
%ENDIF%
%IF%%NUMBER_FAVORITE_VARIABLES%
